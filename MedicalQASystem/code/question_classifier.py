...
class QuestionClassifier:
    def __init__(self):
        ...
        #　特征词路径
        self.disease_path = os.path.join('./MedicalQASystem/dict/disease.txt')
        self.department_path = os.path.join('./MedicalQASystem/dict/department.txt')
        self.check_path = os.path.join('./MedicalQASystem/dict/check.txt')
        self.drug_path = os.path.join('./MedicalQASystem/dict/drug.txt')
        self.food_path = os.path.join('./MedicalQASystem/dict/food.txt')
        self.producer_path = os.path.join('./MedicalQASystem/dict/producer.txt')
        self.symptom_path = os.path.join('./MedicalQASystem/dict/symptom.txt')
        self.deny_path = os.path.join('./MedicalQASystem/dict/deny.txt')
        # 加载特征词
        ...
        self.cureprob_qwds = ['多大概率能治好', '多大几率能治好', '治好希望大么', '几率', '几成', '比例', '可能性', '能治', '可治', '可以治', '可以医','治愈概率']
